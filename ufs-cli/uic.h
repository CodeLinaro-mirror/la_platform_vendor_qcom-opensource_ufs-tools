...
static struct ufs_characteristics unipro_mphy_attrs[] = {
	...
	{0x003B, "TX_HS_PreShoot_Setting"},
	{0x003C, "TX_HS_SYNC_LENGTH_L0_L3"},
	{0x003D, "TX_HS_SYNC_LENGTH_L0_L1_L2_L3"},
	{0x003E, "TX_HS_ADAPT_LENGTH_L0_L1_L2_L3"},
	{0x003F, "TX_TEST_COUNT"},
	{0x0041, "TX_FSM_State"},
	...
	{0x009E, "RX_HS_G4_ADAPT_REFRESH_Capability"},
	{0x009F, "RX_HS_G4_ADAPT_INITIAL_Capability"},
	{0x0071, "RX_HS_G5_SYNC_LENGTH_Capability"},
	{0x0072, "RX_HS_G5_PREPARE_LENGTH_Capability"},
	{0x0073, "RX_HS_G5_ADAPT_REFRESH_Capability"},
	{0x0074, "RX_HS_G5_ADAPT_INITIAL_Capability"},
	{0x0075, "RX_Extended_Min_SAVE_Config_Time_Granularity_Capability"},
	{0x0076, "RX_Extended_Min_SAVE_Config_Time_Capability"},
	{0x0077, "RX_HS_G6_SYNC_L0_L3_LENGTH_Capability"},
	{0x0078, "RX_HS_G6_SYNC_L0_L1_L2_L3_LENGTH_Capability"},
	{0x0079, "RX_HS_G6_PREPARE_LENGTH_Capability"},
	{0x007A, "RX_HS_G6_ADAPT_REFRESH_Capability"},
	{0x007B, "RX_HS_G6_ADAPT_INITIAL_Capability"},
	{0x007C, "RX_HS_G6_ADAPT_REFRESH_L0_L1_L2_L3_Capability"},
	{0x007D, "RX_HS_G6_ADAPT_INITIAL_L0_L1_L2_L3_Capability"},
	{0x00A1, "RX_MODE"},
	...
	{0x00AC, "RX_HS_G6_ADAPT_LENGTH_L0_L3"},
	{0x00AD, "RX_TEST_COUNT"},
	{0x00C1, "RX_FSM_State"},
	{0x00C2, "RX_FOM"},
	{0x00C3, "RX_TestMode_ErrorCounter"},
	...
	{0x15C3, "PA_TFS_FECErrorCount"},
	{0x15C4, "PA_TFS_CRCErrorCount"},
	{0x15C5, "PA_TFS_FormatErrorCount"},
	{0x15C6, "PA_TFS_RecErrorCountL"},
	{0x15C7, "PA_TFS_RecErrorCountH"},
	...
	{0x15D6, "PA_TxHsG5SyncLength"},
	{0x15D7, "PA_TxHsG5PrepareLength"},
	{0x15D8, "PA_PeerRxHsG5AdaptRefresh"},
	{0x15D9, "PA_PeerRxHsG5AdaptInitial"},
	{0x15DA, "PA_TxHsG6SyncLengthL0L3"},
	{0x15DB, "PA_TxHsG6SyncLengthL0L1L2L3"},
	{0x15DC, "PA_TxHsG6PrepareLength"},
	{0x15DD, "PA_PeerRxHsG6AdaptRefreshL0L3"},
	{0x15DE, "PA_PeerRxHsG6AdaptRefreshL0L1L2L3"},
	{0x15DF, "PA_PeerRxHsG6AdaptInitialL0L3"},
	{0x15E0, "PA_PeerRxHsG6AdaptInitialL0L1L2L3"},
	{0x15E1, "PA_TxEQG1Setting"},
	{0x15E2, "PA_TxEQG2Setting"},
	{0x15E3, "PA_TxEQG3Setting"},
	{0x15E4, "PA_TxEQG4Setting"},
	{0x15E5, "PA_TxEQG5Setting"},
	{0x15E6, "PA_TxEQG6Setting"},
	{0x15E7, "PA_TxEQTRSetting"},
	{0x15E8, "PA_PeerTxEQTRSetting"},
	{0x15E9, "PA_PreCodeEn"},
	{0x15EA, "PA_EQTR_Gear"},
	{0x15EB, "PA_TxAdaptLength_EQTR"},
	{0x15EC, "PA_RxHsG6AdaptRefreshL0L3"},
	{0x15ED, "PA_RxHsG6AdaptInitialL0L3"},
	{0x15EE, "PA_PeerTxEQCap"},
	...
	{0x5114, "DME_RX_PAERROR_IND_DATA_OFL"},
	{0x5115, "DME_RX_PAERROR_IND"},
	{0x5116, "DME_RX_PAERROR_IND_QoS_COUNT"},
	{0x5117, "DME_RX_DL_LM_ERROR_PAERROR_IND"},
